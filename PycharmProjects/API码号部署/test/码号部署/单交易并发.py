...
file_path_1 = 'D:\\桌面\\1130_1.pgp'
file_path_2 = 'D:\\桌面\\1130_2.pgp'
file_path_3 = 'D:\\桌面\\1130_3.pgp'
file_path_4 = 'D:\\桌面\\1130_4.pgp'
file_path_5 = 'D:\\桌面\\1130_5.pgp'
pgp_file_contents = []
# 读取文件内容并添加到列表
with open(file_path_1, 'r', encoding='utf-8') as file:
    pgp_file_contents.append(file.read())
...
def send_request(iccid, profile_type_name, pgp_file_content):
    ...
    with requests.Session() as session:
        ...
        try:
            ...
            if "rsp-0002.linksfield.net" in result.get("data", {}).get("qrCode", "").lower():
