...
# 循环发送请求
for i in range(999,22645):
    iccid = f"8901152900000000{i + 1:02d}"
    #89820220926999202000
    #89011529000000000000-89011529000000022638
    #89011529000000011304-89011529000000012303
    # 定义请求参数
    payload = {
