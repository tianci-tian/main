...
class APITestBase:
    ...
    def generate_secret_key(self):
        get_key_url = "https://lk-api-v2.linksfield.net/mp/debug/secret/generateSecretKey"
...
class APITEST(APITestBase):
    ...
    def productList(self, access_key, signature):
        url = "https://lk-api-v2.linksfield.net" + self.path
...
class TestAPITEST(unittest.TestCase):
    ...
    def test_api_productList(self):
        api_test = APITEST("/mp-api/api/esim/v2/productList", "GET", "SUPV9TB9OS")
